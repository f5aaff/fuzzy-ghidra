...
BINARY_FILE = os.path.join(
    os.path.dirname(os.path.abspath(__file__)), "less_simple_target.bin"
)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Test harness for less_simple_target.bin")
    parser.add_argument(
        "input_file",
        type=str,
